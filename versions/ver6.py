...
def detect_machine_input(time_stamps):
    # Anti-cheat detection thresholds - tune as needed
    ...
    if min_time < MIN_TIME_THRESHOLD and std_dev < MAX_STD_THRESHOLD:
        return True
    return False
...
def print_with_highlight(original_text, current_index):
    ...
    for i, c in enumerate(original_text):
        if i == current_index:
            ...
            print(c, end="")
    print("  ", end="", flush=True)  # Clear leftover characters
