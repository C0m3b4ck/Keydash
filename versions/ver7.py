...
def keydash():
    ...
    while True:
        ...
        typing_stopped_due_to_error = False
        ...
        while current_index < len(text):
            ...
            # Check correct character immediately
            expected_char = text[current_index]
            if ch != expected_char:
                print(f"\n{Colors.RED}\nTypo detected at position {current_index + 1}!")
                print(f"Expected '{expected_char}' but got '{ch}'. Stopping typing.{Colors.RESET}\n")
                typing_stopped_due_to_error = True
                break  # stop accepting more input at first typo
