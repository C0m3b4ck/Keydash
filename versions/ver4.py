...
def plot_stats():
    ...
    plt.subplot(2, 2, 1)
    plt.plot(x_vals, wpms, marker='o', color='blue')
    plt.title('WPM over Runs')
    plt.xlabel('Run Number')
    plt.ylabel('WPM')

    plt.subplot(2, 2, 2)
    plt.plot(x_vals, accuracies, marker='o', color='green')
    plt.title('Accuracy (%) over Runs')
    plt.xlabel('Run Number')
    plt.ylabel('Accuracy (%)')

    plt.subplot(2, 2, 3)
    plt.plot(x_vals, times, marker='o', color='red')
    plt.title('Time Taken (seconds) over Runs')
    plt.xlabel('Run Number')
    plt.ylabel('Time (s)')

    plt.subplot(2, 2, 4)
    plt.plot(x_vals, avg_times_btwn_letters, marker='o', color='purple')
    plt.title('Avg Time Between Letters (seconds) over Runs')
    plt.xlabel('Run Number')
    plt.ylabel('Avg Time Between Letters (s)')
